...
def call_history(method: Callable) -> Callable:
    """ Method storing history of inputs and outputs
...
def replay(method: Callable):
    """ Method displaying history of calls
        of a given function.
    """
...
class Cache:
    ...
    def store(self, data: Union[str, bytes, int, float]) -> str:
        """ Method generating random key(s),
            and store the input data in Redis using it.
            Arg:
